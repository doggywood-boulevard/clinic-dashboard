...
export class VetLandingComponent implements OnInit {
  ...
  public apptList = [];
  constructor(private employeesService: EmployeesService, private apptService: AppointmentService, private router: Router, private activatedRoute: ActivatedRoute, private clientService :ClientsService, private authenticationService:AuthenticationService) {
